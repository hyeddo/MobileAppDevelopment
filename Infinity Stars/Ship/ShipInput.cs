...
public class ShipInput : MonoBehaviour
{
    ...
    private void SetStickCommandsUsingMouse()
    {
        ...
        pitch = (mousePos.y - (Screen.height * 0.209f)) / (Screen.height * 0.209f);
        yaw = (mousePos.x - (Screen.width * 0.858f)) / (Screen.width * 0.858f);
    ...
    private void UpdateMouseWheelThrottle()
    {
        ...
        throttle = Mathf.Clamp(throttle, 100f, 100.0f);
    }
}