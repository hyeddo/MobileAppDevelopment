...
     void OnTriggerEnter(Collider other)     {         if (other.tag == "Ast")         {
...
         ending.enabled = false; //endgame을 비활성화 한다        //박스 초기화                  //    SceneManager.LoadScene("CJ");          Debug.Log("bring back");           }
    ...
    public void Restart7()
    {
        ...
        ending.enabled = false; //endgame을 비활성화 한다        //박스 초기화 
